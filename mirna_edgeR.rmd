...
raw_counts_named2 <- left_join(raw_counts_filtered, results_Y, by="known_miRNAs")

write.csv(raw_counts_named2, file.path(getwd(),"results/raw_counts_named_sequences.csv"))


write.csv(raw_counts_filtered, file.path(getwd(),"results/counts_filtered.csv"))
write.csv(raw_counts_named, file.path(getwd(),"results/counts_filtered_named.csv"))
...
qlf_test <- function(con, contr_name) {
  ...
  top_tags <- as.data.frame(topTags(qlf , n=nrow(res_qlf)))
